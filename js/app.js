...
function leerDatoFormulario(e) {
  ...
  if (datoIngresado === numeroMagico) {
    ...
    alert('El número que ingresaste es menor al número mágico. El número era: '+numeroMagico);
  } else {
    alert('El número que ingresaste es mayor al número mágico. El número era: '+numeroMagico);
  }
